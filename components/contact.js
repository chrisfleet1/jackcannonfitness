...
export default function Contact() {
  return (
      <section className={styles.subsections}>
        ...
        <form className={styles.form_container} data-netlify="true" method='POST' name="contact" data-netlify-recaptcha="true" data-netlify-honeypot="bot-field" action="Thank you">
